...
@section('title', __('option::options.edit', ['name' => $option->label]))
@section('content')
                    ...
                    <div class="kt-portlet__head">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">
                                {{ __($title ?? 'option::options.edit', ['name' => $option->label]) }}
                            </h3>
                        </div>
                    </div>
                    <div class="kt-portlet__body">
                        <div class="kt-section">
                            <span class="kt-section__info">
                                {{ __('Utilize o formulário abaixo para editar uma opção') }}
                            </span>
